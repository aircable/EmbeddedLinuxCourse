// sourced http://www.kernel.org/doc/man-pages/online/pages/man3/pthread_create.3.html
...
int main(int argc, char *argv[]) {
  ...
  if (s != 0) handle_error_en(s, "pthread_attr_init");
	...
	if (stack_size > 0) {
		...
		fprintf(stderr,"Set Stack Size to `%d` for '%d'.\n",stack_size,gettid());
